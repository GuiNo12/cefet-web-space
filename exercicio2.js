...
//criar evendo para passar imagens botão próximo
...
let imagemAtual = document.querySelector('#slide');

function proximo() {
  let img = imagens.shift();
  imagens.push(img);
  imagemAtual.src = servidorDasImagens + '/' + imagens[0].arquivo;
  imagemAtual.alt = imagens[0].descricao;
}
